    ...
    public class CustomerManager
    {
        ...
        private Dictionary<int, List<List<CustomerType>>> customerTypeGroupings = new Dictionary<int, List<List<CustomerType>>>()
        {
            // TODO: add specific for group 
             ...
             { 7, new List<List<CustomerType>> // don't forget to be bitter or debbydowner
                 {
                    ...
                    new List<CustomerType> { CustomerType.Cheap, CustomerType.Picky, CustomerType.Diverse },
                    ...
                    new List<CustomerType> { CustomerType.Spontaneous, CustomerType.Impatient, CustomerType.Minimalist },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Maximalist, CustomerType.Patient },
             ...
             // 3-4 types, aim for 22 requests
                 {
                    ...
                    new List<CustomerType> { CustomerType.Minimalist, CustomerType.BigSpender, CustomerType.Patient, CustomerType.Bitter },
                    new List<CustomerType> { CustomerType.Indifferent, CustomerType.Cheap, CustomerType.Specific, CustomerType.Impatient },
                    new List<CustomerType> { CustomerType.Budgeter, CustomerType.Cheap, CustomerType.Picky },
                    new List<CustomerType> { CustomerType.Budgeter, CustomerType.Practical, CustomerType.Minimalist }, 
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Patient, CustomerType.Maximalist }, 
                    ...
                    new List<CustomerType> { CustomerType.Luxury, CustomerType.Diverse, CustomerType.Maximalist },
                    new List<CustomerType> { CustomerType.Luxury, CustomerType.Diverse, CustomerType.Patient }, 
                    new List<CustomerType> { CustomerType.Spontaneous, CustomerType.Impatient, CustomerType.Minimalist, CustomerType.DebbyDowner },
             ...
             // mood + cost + patience + (risky, speed, # of items, group, budget, quality)  
             // mood - bitter (upset hap), debbydowner (fine hap), demanding (range), forgiving (range), indifferent (range)
                 {
                    new List<CustomerType> { CustomerType.Picky, CustomerType.Patient, CustomerType.Maximalist, CustomerType.Luxury },
                    new List<CustomerType> { CustomerType.Maximalist, CustomerType.Cheap, CustomerType.Spontaneous, CustomerType.Forgiving },
                    new List<CustomerType> { CustomerType.Minimalist, CustomerType.BigSpender, CustomerType.Picky, CustomerType.Specific, CustomerType.Indifferent },
                    new List<CustomerType> { CustomerType.Diverse, CustomerType.BigSpender, CustomerType.DebbyDowner, CustomerType.Budgeter },
                    new List<CustomerType> { CustomerType.Average, CustomerType.Impatient,CustomerType.Diverse, CustomerType.Demanding },
                    new List<CustomerType> { CustomerType.Impatient, CustomerType.BigSpender, CustomerType.Picky, CustomerType.Minimalist  },
                    new List<CustomerType> { CustomerType.Patient, CustomerType.Average, CustomerType.DebbyDowner, CustomerType.Indifferent },
                    ...
                    new List<CustomerType> { CustomerType.Minimalist, CustomerType.BigSpender, CustomerType.Patient, CustomerType.Bitter },
                    new List<CustomerType> { CustomerType.Indifferent, CustomerType.Cheap, CustomerType.Specific, CustomerType.Impatient },
                    new List<CustomerType> { CustomerType.Budgeter, CustomerType.Cheap, CustomerType.Picky, CustomerType.Practical },
                    new List<CustomerType> { CustomerType.Budgeter, CustomerType.Practical, CustomerType.Minimalist, CustomerType.Forgiving },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Patient, CustomerType.Maximalist, CustomerType.Average },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Impatient, CustomerType.Minimalist, CustomerType.Spontaneous, CustomerType.Luxury },
                    new List<CustomerType> { CustomerType.Budgeter, CustomerType.Maximalist, CustomerType.Cheap, CustomerType.Patient },
                    new List<CustomerType> { CustomerType.Luxury, CustomerType.Diverse, CustomerType.Maximalist, CustomerType.Bitter },
                    new List<CustomerType> { CustomerType.Luxury, CustomerType.Diverse, CustomerType.Patient, CustomerType.Specific },
                    new List<CustomerType> { CustomerType.Spontaneous, CustomerType.Patient, CustomerType.Minimalist, CustomerType.DebbyDowner },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Diverse, CustomerType.Cheap, CustomerType.Impatient, CustomerType.Budgeter },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Diverse, CustomerType.Average, CustomerType.Patient },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Diverse, CustomerType.BigSpender, CustomerType.Luxury },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Diverse, CustomerType.Cheap, CustomerType.Picky },
                    new List<CustomerType> { CustomerType.Specific, CustomerType.Diverse, CustomerType.Average, CustomerType.Budgeter, CustomerType.Maximalist },
             ...
             // TODO add a 5th itemz
                 {
                    ...
                    new List<CustomerType> { CustomerType.Maximalist, CustomerType.Cheap, CustomerType.Picky, CustomerType.Bitter, CustomerType.Budgeter },
                    ...
                    new List<CustomerType> { CustomerType.Maximalist, CustomerType.Average, CustomerType.Spontaneous, CustomerType.Indifferent, CustomerType.DebbyDowner },
                    new List<CustomerType> { CustomerType.Minimalist, CustomerType.Luxury, CustomerType.Picky, CustomerType.Demanding, CustomerType.Specific },
                    new List<CustomerType> { CustomerType.Diverse, CustomerType.BigSpender, CustomerType.Patient, CustomerType.DebbyDowner, CustomerType.Spontaneous},
                    new List<CustomerType> { CustomerType.BigSpender, CustomerType.Impatient,CustomerType.Diverse, CustomerType.Specific, CustomerType.Demanding },
                    new List<CustomerType> { CustomerType.Impatient, CustomerType.BigSpender, CustomerType.Diverse, CustomerType.DebbyDowner, CustomerType.Forgiving },
                    ...
                    new List<CustomerType> { CustomerType.Spontaneous, CustomerType.Luxury, CustomerType.Diverse, CustomerType.Forgiving, CustomerType.Indifferent },
                    new List<CustomerType> { CustomerType.Minimalist, CustomerType.Luxury, CustomerType.Impatient, CustomerType.DebbyDowner, CustomerType.Budgeter },
